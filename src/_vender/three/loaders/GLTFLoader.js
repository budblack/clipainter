	...
	function () {
		...
		GLTFLoader.prototype = {
			...
			parse: function (data, callback, path) {
				...
				parser.parse(
					function (scene, scenes, cameras, animations) {
		...
		GLTFParser.prototype._withDependencies = function (dependencies) {
			...
			return _each(
				_dependencies, function (dependency) {
						...
						json.shaders, function (shader) {
							...
							return new Promise(
								function (resolve) {
									...
									loader.load(
										resolveURL(shader.uri, options.path), function (shaderText) {
		...
		GLTFParser.prototype.loadBuffers = function () {
			...
			return _each(
				json.buffers, function (buffer, name) {
					...
					if (buffer.type === 'arraybuffer' || buffer.type === undefined) {
						...
						return new Promise(
							function (resolve) {
								...
								loader.setResponseType('arraybuffer');
								loader.load(
									resolveURL(buffer.uri, options.path), function (buffer) {
		...
		GLTFParser.prototype.loadBufferViews = function () {
			...
			return this._withDependencies(
				...
				function (dependencies) {
					...
					return _each(
						json.bufferViews, function (bufferView) {
		...
		GLTFParser.prototype.loadAccessors = function () {
			...
			return this._withDependencies(
				...
				function (dependencies) {
					...
					return _each(
						json.accessors, function (accessor) {
		...
		GLTFParser.prototype.loadTextures = function () {
			...
			return this._withDependencies(
				...
				function (dependencies) {
					...
					return _each(
						json.textures, function (texture) {
							...
							if (texture.source) {
								...
								return new Promise(
									function (resolve) {
										...
										textureLoader.load(
											resolveURL(sourceUri, options.path), function (_texture) {
		...
		GLTFParser.prototype.loadMaterials = function () {
			...
			return this._withDependencies(
				...
				function (dependencies) {
					...
					return _each(
						json.materials, function (material) {
						...
						json.meshes, function (mesh) {
							...
							for (var name in primitives) {
								...
								if (primitive.mode === WEBGL_CONSTANTS.TRIANGLES || primitive.mode === undefined) {
									...
									meshNode.name       = (
										name === "0" ? group.name : group.name + name
									);
		...
		GLTFParser.prototype.loadAnimations = function () {
			...
			return this._withDependencies(
				...
				function (dependencies) {
					...
					return _each(
						json.animations, function (animation, animationId) {
